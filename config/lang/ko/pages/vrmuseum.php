...
return [
    ...
    'hero' => [
        'title' => '360°VR Museum',
        'subtitle' => '국내외 모든 전시를 PC와 모바일에서 풀 HD로 감상이 가능한 가상 전시 관람 서비스 플랫폼입니다. 시간과 장소에 구애받지 않고 언제 어디서나 자유롭게 전시를 관람해보세요.',
    ],
    'introEasy' => [
    ...
    'artEducation' => [
        'title' => '역사 교육에 <br />혁신을 더하다',
        'intro' => '
역사 교육 수업에 혁신을 더해보세요. 학교 안에서 가상 박물관 체험으로 학습의 질을 올리고 학생들의 흥미를 이끌어보세요. 학교 수업이 끝난 후, 360° VR Museum을 통한 교육이 지속될 수 있습니다.
<br /><br />
<strong>
